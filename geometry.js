...
{
	var floatCircleArea = parseFloat ((Math.PI) * (floatRadius_par * floatRadius_par));
...
function rectArea(floatRectWidth_par, floatRectHeight_par) {
   ...
   var floatRectArea = parseFloat(floatRectWidth_par) * parseFloat(floatRectHeight_par);
...
function rectPerim(floatRectWidth_par, floatRectHeight_par) {
   ...
   var floatRectPerim = parseFloat((floatRectWidth_par + floatRectHeight_par)*2);
...
function triArea(floatTriSide1_par, floatTriSide2_par, floatTriSide3_par) {
   ...
   var floatTriArea = parseFloat((floatTriSide1_par*floatTriSide2_par)/2); //check this with Graces program, not too sure about this calculation haha
